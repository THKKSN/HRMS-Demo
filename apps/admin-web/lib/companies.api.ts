...
export const companiesApi = {
  ...
  create: (body: { name: string; nameEn?: string; nameId?: string; orgType: string; parentId?: string; isHeadquarters?: boolean }) =>
    api.post<CompanyDto>('/companies', body).then((r) => r.data),

  update: (
    id: string,
    body: { name: string; nameEn?: string; nameId?: string; orgType: string; parentId?: string; isActive: boolean; isHeadquarters: boolean },
