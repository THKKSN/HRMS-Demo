...
namespace Hrms.Infrastructure.Migrations
{
    ...
    [Migration("20260826050601_AddMemoModule")]
    partial class AddMemoModule
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Hrms.Domain.Entities.Memo", b =>
                {
                    ...
                    b.Property<Guid?>("ResolvedApproverEmployeeId")
                        .HasColumnType("char(36)")
                        .HasColumnName("resolved_approver_employee_id");

                    b.Property<Guid?>("ResolvedRoutingId")
                        .HasColumnType("char(36)")
                        .HasColumnName("resolved_routing_id");
                    ...
                    b.HasIndex("ResolvedApproverEmployeeId")
                        .HasDatabaseName("ix_memos_resolved_approver_employee_id");

                    b.HasIndex("ResolvedRoutingId")
                        .HasDatabaseName("ix_memos_resolved_routing_id");
            ...
            modelBuilder.Entity("Hrms.Domain.Entities.MemoRouting", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_memo_routings");

                    b.HasIndex("ApproverRoleId")
                        .HasDatabaseName("ix_memo_routings_approver_role_id");

                    b.HasIndex("CompanyId")
                        .HasDatabaseName("ix_memo_routings_company_id");

                    b.HasIndex("DepartmentId")
                        .HasDatabaseName("ix_memo_routings_department_id");

                    b.HasIndex("MemoTypeId", "CompanyId", "DepartmentId")
                        .HasDatabaseName("ix_memo_routings_resolve_lookup");

                    b.HasIndex("MemoTypeId", "CompanyId", "DepartmentId", "Priority")
                        .HasDatabaseName("ix_memo_routings_type_company_department_priority");

                    b.ToTable("memo_routings", (string)null);
                });
            ...
            modelBuilder.Entity("Hrms.Domain.Entities.Memo", b =>
                {
                    ...
                    b.HasOne("Hrms.Domain.Entities.Employee", "ResolvedApproverEmployee")
                        .WithMany()
                        .HasForeignKey("ResolvedApproverEmployeeId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("fk_memos_employees_resolved_approver_employee_id");

                    b.HasOne("Hrms.Domain.Entities.MemoRouting", "ResolvedRouting")
                        .WithMany()
                        .HasForeignKey("ResolvedRoutingId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("fk_memos_memo_routings_resolved_routing_id");
                    ...
                    b.Navigation("ResolvedApproverEmployee");

                    b.Navigation("ResolvedRouting");
                });
            ...
            modelBuilder.Entity("Hrms.Domain.Entities.MemoRouting", b =>
                {
                    b.HasOne("Hrms.Domain.Entities.SystemRole", "ApproverRole")
                        .WithMany()
                        .HasForeignKey("ApproverRoleId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_memo_routings_system_roles_approver_role_id");

                    b.HasOne("Hrms.Domain.Entities.Company", "Company")
                        .WithMany()
                        .HasForeignKey("CompanyId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_memo_routings_companies_company_id");

                    b.HasOne("Hrms.Domain.Entities.Department", "Department")
                        .WithMany()
                        .HasForeignKey("DepartmentId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_memo_routings_departments_department_id");
                    ...
                    b.HasOne("Hrms.Domain.Entities.MemoType", "MemoType")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_memo_routings_memo_types_memo_type_id");
