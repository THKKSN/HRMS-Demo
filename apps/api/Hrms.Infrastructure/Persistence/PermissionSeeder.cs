...
public class PermissionSeeder(HrmsDbContext db)
{
    ...
    [
        ...
        ("ticket:manage-closeout-reasons", "ticket-taxonomy", "manage", "จัดการประเภทปัญหา/เหตุผลปิดงานของแจ้งเรื่อง"),
        ("ticket:manage-team-templates", "ticket-taxonomy", "manage", "จัดการทีมสำเร็จรูปของระบบแจ้งเรื่อง"),
        ...
        // การ์ดกิจกรรมในบอร์ด — เช็กคู่กับความเกี่ยวข้องกับ ticket (ผู้รับผิดชอบ/หัวหน้าแผนก/Admin) เสมอ
        ("ticket:edit-progress-entry",     "ticket", "update",      "แก้ไขการ์ดกิจกรรมที่ตนเองสร้าง"),
        ("ticket:edit-any-progress-entry", "ticket", "update",      "แก้ไขการ์ดกิจกรรมทุกใบในงานที่ดูแล"),
        ("ticket:pin-progress-entry",      "ticket", "update",      "ปักหมุดการ์ดกิจกรรมในบอร์ด"),
        // ทีมงานในใบแจ้งเรื่อง — เช็กคู่กับความเกี่ยวข้องกับ ticket เสมอ (ผู้รับผิดชอบหลัก/หัวหน้าแผนก/Admin)
        ("ticket:manage-team",             "ticket", "assign",      "เพิ่ม/ถอดผู้ร่วมงานในใบแจ้งเรื่อง"),
        ("ticket:work-as-team-member",     "ticket", "update",      "ทำงานในใบแจ้งเรื่องที่ถูกดึงเข้าทีม"),
    ...
    private static readonly Dictionary<string, string[]> DefaultRolePermissions = new()
    {
        ...
        [
            ...
            "ticket:edit-progress-entry", "ticket:pin-progress-entry",
            "ticket:manage-team", "ticket:work-as-team-member",
        ...
        [
            ...
            "ticket:manage-external-config", "ticket:manage-closeout-reasons",
            "ticket:manage-team-templates",
            "ticket:comment", "ticket:add-internal-note", "ticket:add-attachment",
            "ticket:return", "ticket:view-report",
            "ticket:edit-progress-entry", "ticket:edit-any-progress-entry", "ticket:pin-progress-entry",
            "ticket:manage-team", "ticket:work-as-team-member",
            "expense:create", "expense:view-own", "expense:update-draft", "expense:upload-attachment", "expense:ocr",
